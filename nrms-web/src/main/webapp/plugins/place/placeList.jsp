			...
			<div class="up-tab-pane up-active" id="tabs1">
				<div class="border_btm first_title">
					<h4 class="up-top-cq-color">
						<span class="icon-right-dir"></span>会议室列表
					</h4>
				</div>
										...
										<div class="up-cq-table-outer">
											<div class="up-cq-table-inner">
													...
													<div class="reference_search">
														<form class="up-form-inline" id="searchForm" method="post" action="${basePath }/place/placeList">
															...
															<div class="up-form-group">
																<label for="" class="up-control-label">会议室名称:</label> 
												...
												<table
													...
													<tbody>
														<c:forEach var="place" items="${page.dataList }" varStatus="status">
															<tr>
																<td>${status.index + 1}</td>
																<td>${place.placeName}</td>
																<td>${place.placeDesc}</td>
																<td>
																	<a href="javascript:void(0)" onClick="showDialog('编辑会议室' , '${basePath}/place/toAddOrEditPlace?id=${place.id }' , '470px')">编辑</a>
																	<a href="javascript:void(0)" onClick="deletePlace('${place.id}')">删除</a>
																</td>
															</tr>
														</c:forEach>
													</tbody>
