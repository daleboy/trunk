...
public class MailUtil {
    ...
    static class Th extends Thread {
        ...
        public Th(String conferenceName, String conferenceTime, String conferenceLocation, List<String> targetList) {
    ...
    public static void sendByDefault(String conferenceName, String conferenceTime, String conferenceLocation, List<String> targetList) throws MessagingException, IOException {
        ...
        new Th(conferenceName,conferenceTime,conferenceLocation,targetList).start();
    }
